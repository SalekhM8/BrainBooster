  ...
  return (
    <div className="min-h-screen bg-[#f5f7fc] text-[#0d1b3e] antialiased">
          ...
          <div className="border-t border-white/10 bg-[#0f2557]/95 backdrop-blur-xl md:hidden">
            <div className="space-y-1 px-5 py-3">
              ...
              <Link
                href="#trial"
                onClick={() => setMobileOpen(false)}
                className="mt-2 block rounded-md bg-[#4a8fe8] px-4 py-2 text-center text-sm font-semibold text-white"
              >
                Book a free trial
              </Link>
            </div>
            ...
            <div className="grid items-center gap-12 lg:grid-cols-[1.05fr_0.95fr]">
              ...
              <div className="relative hidden lg:block">
                ...
                <div className="absolute -bottom-4 -left-4 rounded-xl border border-white/15 bg-white/[0.1] px-3 py-2 backdrop-blur-xl">
                  <div className="flex items-center gap-2">
                    <div className="flex h-7 w-7 items-center justify-center rounded-full bg-[#25D366]/90">
                      <svg viewBox="0 0 24 24" className="h-4 w-4 text-white" fill="currentColor">
                        <path d="M20.5 3.5A11.6 11.6 0 0 0 12 0C5.4 0 0 5.4 0 12c0 2.1.5 4 1.5 5.7L0 24l6.5-1.7A11.9 11.9 0 0 0 12 24c6.6 0 12-5.4 12-12 0-3.2-1.2-6.2-3.5-8.5Z" />
                      </svg>
                    </div>
                    <div>
      ...
      <a
        ...
        className="fixed bottom-5 right-5 z-40 flex h-12 w-12 items-center justify-center rounded-full bg-[#25D366] text-white shadow-[0_10px_30px_-6px_rgba(37,211,102,0.6)] transition-transform hover:-translate-y-0.5"
      >
